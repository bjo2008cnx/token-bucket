...
public class RateLimiterTest extends TestCase {
  ...
  public void testSimple() {
    com.google.common.util.concurrent.RateLimiter limiter = com.google.common.util.concurrent.RateLimiter.create(stopwatch, 5.0);
  ...
  public void testImmediateTryAcquire() {
    com.google.common.util.concurrent.RateLimiter r = com.google.common.util.concurrent.RateLimiter.create(1);
  ...
  public void testDoubleMinValueCanAcquireExactlyOnce() {
    com.google.common.util.concurrent.RateLimiter r = com.google.common.util.concurrent.RateLimiter.create(stopwatch, Double.MIN_VALUE);
    assertTrue("Unable to acquire initial permit", r.tryAcquire());
  ...
  public void testSimpleRateUpdate() {
    com.google.common.util.concurrent.RateLimiter limiter = com.google.common.util.concurrent.RateLimiter.create(5.0, 5, SECONDS);
  ...
  public void testAcquireParameterValidation() {
    com.google.common.util.concurrent.RateLimiter limiter = com.google.common.util.concurrent.RateLimiter.create(999);
    try {
      limiter.acquire(0);
      fail();
    } catch (IllegalArgumentException expected) {
  ...
  public void testCreateWarmupParameterValidation() {
    com.google.common.util.concurrent.RateLimiter unused;
    unused = com.google.common.util.concurrent.RateLimiter.create(1.0, 1, NANOSECONDS);
    unused = com.google.common.util.concurrent.RateLimiter.create(1.0, 0, NANOSECONDS);

    try {
      com.google.common.util.concurrent.RateLimiter.create(0.0, 1, NANOSECONDS);
      fail();
    } catch (IllegalArgumentException expected) {
    }

    try {
      com.google.common.util.concurrent.RateLimiter.create(1.0, -1, NANOSECONDS);
      fail();
    } catch (IllegalArgumentException expected) {
    }
  }
  ...
  public void testWarmUp() {
    com.google.common.util.concurrent.RateLimiter limiter = com.google.common.util.concurrent.RateLimiter.create(stopwatch, 2.0, 4000, MILLISECONDS, 3.0);
    for (int i = 0; i < 8; i++) {
      limiter.acquire(); // #1
    }
  ...
  public void testWarmUpWithColdFactor() {
    com.google.common.util.concurrent.RateLimiter limiter = com.google.common.util.concurrent.RateLimiter.create(stopwatch, 5.0, 4000, MILLISECONDS, 10.0);
    for (int i = 0; i < 8; i++) {
      limiter.acquire(); // #1
    }
  ...
  public void testWarmUpWithColdFactor1() {
    com.google.common.util.concurrent.RateLimiter limiter = com.google.common.util.concurrent.RateLimiter.create(stopwatch, 5.0, 4000, MILLISECONDS, 1.0);
    for (int i = 0; i < 8; i++) {
      limiter.acquire(); // #1
    }
  ...
  public void testBurstyAndUpdate() {
    com.google.common.util.concurrent.RateLimiter rateLimiter = com.google.common.util.concurrent.RateLimiter.create(stopwatch, 1.0);
  ...
  public void testInfinity_Bursty() {
    com.google.common.util.concurrent.RateLimiter limiter = com.google.common.util.concurrent.RateLimiter.create(stopwatch, Double.POSITIVE_INFINITY);
  ...
  public void testInfinity_WarmUp() {
    com.google.common.util.concurrent.RateLimiter limiter = com.google.common.util.concurrent.RateLimiter.create(
  ...
  public void testInfinity_WarmUpTimeElapsed() {
    com.google.common.util.concurrent.RateLimiter limiter = com.google.common.util.concurrent.RateLimiter.create(stopwatch, Double.POSITIVE_INFINITY, 10, SECONDS, 3.0);
    stopwatch.instant += 1000000;
    limiter.setRate(1.0);
    for (int i = 0; i < 5; i++) {
      limiter.acquire();
  ...
  public void testWeNeverGetABurstMoreThanOneSec() {
    com.google.common.util.concurrent.RateLimiter limiter = com.google.common.util.concurrent.RateLimiter.create(stopwatch, 1.0);
    ...
    for (int trial = 0; trial < 100; trial++) {
      for (double coldFactor : coldFactorsToTest) {
        for (double qps : qpsToTest) {
          ...
          com.google.common.util.concurrent.RateLimiter rateLimiter = com.google.common.util.concurrent.RateLimiter.create(
  ...
  public void testNulls() {
    NullPointerTester tester = new NullPointerTester()
        .setDefault(com.google.common.util.concurrent.RateLimiter.SleepingStopwatch.class, stopwatch)
        .setDefault(int.class, 1)
        .setDefault(double.class, 1.0d);
    tester.testStaticMethods(com.google.common.util.concurrent.RateLimiter.class, Visibility.PACKAGE);
    tester.testInstanceMethods(com.google.common.util.concurrent.RateLimiter.create(stopwatch, 5.0), Visibility.PACKAGE);
  }

  public void testVerySmallDoubleValues() throws Exception {
    com.google.common.util.concurrent.RateLimiter rateLimiter = com.google.common.util.concurrent.RateLimiter.create(stopwatch, Double.MIN_VALUE);
  ...
  private long measureTotalTimeMillis(com.google.common.util.concurrent.RateLimiter rateLimiter, int permits, Random random) {
   ...
   */
  static class FakeStopwatch extends com.google.common.util.concurrent.RateLimiter.SleepingStopwatch {
    long instant = 0L;
  ...
  public void testMockingMockito() throws Exception {
    com.google.common.util.concurrent.RateLimiter mock = Mockito.mock(com.google.common.util.concurrent.RateLimiter.class);
    doTestMocking(mock);
  }
  ...
  public void testMockingEasyMock() throws Exception {
    com.google.common.util.concurrent.RateLimiter mock = EasyMock.createNiceMock(com.google.common.util.concurrent.RateLimiter.class);
    EasyMock.replay(mock);
    doTestMocking(mock);
  }

  private static void doTestMocking(com.google.common.util.concurrent.RateLimiter mock) throws Exception {
